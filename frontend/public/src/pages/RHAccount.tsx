/**
 * RHAccount.tsx — /rh/account
 * Same design as ManagerAccount: floating purple sidebar + wave background
...
import {
  User, Mail, Briefcase as BriefcaseIcon,
...
// ─── Main component ────────────────────────────────────────────────────────────
export default function RHAccount() {
  ...
  const displayName = fullName || "HR Manager";
                ...
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 14, flexShrink: 0 }}>
                  <div style={{ position: "relative" }}>
                    ...
                    <div style={{
                      ...
                      background: avatarPreview ? "transparent" : getGradient(displayName),
